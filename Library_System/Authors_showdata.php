...
$query="SELECT * FROM authors";//sary column ka data lana ho
...
<span><marquee>This is libraray managment system.Libraray system at 8:00 am and close at 4:00pm</marquee>
            ...
            <div  class="col-6" id="content">
                <h2 class="text-center">Authors-Data</h2>
...
?>
       ...
       <td><a href="update_author.php?id=<?php echo $row['ID']; ?>" >Update</a></td>
